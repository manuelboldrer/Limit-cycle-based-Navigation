function [F_lc, rot_matrix, omega_gain,direction] = dynamic_obstacle_limit_cycles3(x_robot, y_robot, theta_robot, v_robot, x_obstacle, y_obstacle, v_x_obstacle, v_y_obstacle, params, F_permanent, egg, waypoints, F_max1)
